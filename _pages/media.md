...
<p class="small">
Replace placeholders with your files at <code>assets/img/media/chinese-passenger/poster.jpg</code> and <code>assets/img/media/chinese-passenger/still-1.jpg</code> (I’ll wire them in).
</p>
